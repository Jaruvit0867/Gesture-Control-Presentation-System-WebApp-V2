  ...
  const features = [
    {
      step: '01',
      title: 'Upload PDF',
      desc: 'Drag and drop or click to upload your presentation. Supports all PDF formats.',
      icon: Upload,
      color: 'aurora-cyan',
    },
    {
      step: '02',
      title: 'Enable Camera',
      desc: 'Start your webcam for gesture detection. All processing stays on your device.',
      icon: Camera,
      color: 'aurora-purple',
    },
    {
      step: '03',
      title: 'Present!',
      desc: 'Control your slides with natural hand gestures. Swipe to navigate seamlessly.',
      icon: Presentation,
      color: 'aurora-pink',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-dark-950 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div
          className="aurora-orb w-[600px] h-[600px] bg-aurora-cyan/20 -top-[20%] -left-[10%]"
          style={{ animationDelay: '0s' }}
        />
        <div
          className="aurora-orb w-[500px] h-[500px] bg-aurora-purple/20 top-[30%] -right-[15%]"
          style={{ animationDelay: '5s' }}
        />
        <div
          className="aurora-orb w-[400px] h-[400px] bg-aurora-pink/15 -bottom-[10%] left-[20%]"
          ...
          {!isFullscreen && (
            ...
            >
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-aurora-cyan/20 mb-8"
              >
                <Sparkles className="w-4 h-4 text-aurora-cyan" />
                <span className="text-xs font-medium text-aurora-cyan uppercase tracking-wider">
              ...
              <p className="text-slate-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mb-8">
                Experience the future of presentations. Navigate your slides naturally
                with intuitive hand movements - no clicker needed.
              </p>
          ...
          >
            ...
            <div className={`
              ...
              ${isFullscreen
                ...
                : 'lg:col-span-2 glass rounded-3xl p-8 h-[680px] border border-dark-700/50'
              }
            `}>
              <PdfViewer
                pageImage={pageImage}
            ...
            {/* Gesture Camera - Sidebar */}
            <div className={`
              transition-all duration-500
              ${isFullscreen
                ? 'fixed bottom-6 right-6 w-72 z-[70]'
            ...
            `}>
              ...
              {/* Quick Tips Card - only in non-fullscreen */}
              {!isFullscreen && (
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <h3 className="font-display font-bold text-white mb-4 flex items-center gap-2">
                    <div className="w-6 h-6 rounded-lg bg-aurora-cyan/10 flex items-center justify-center">
                      <Zap className="w-3.5 h-3.5 text-aurora-cyan" />
                    </div>
                    Quick Tips
                  </h3>
                  <ul className="space-y-3 text-sm">
                    {[
                      ...
                      'Make a fist to pause detection',
                      'Point with one finger for pointer mode',
                    ].map((tip, i) => (
                      <li key={i} className="flex items-start gap-3 text-slate-400">
                        <div className="w-5 h-5 rounded-full bg-dark-800 border border-dark-700 flex items-center justify-center flex-shrink-0 mt-0.5">
            ...
            >
              ...
              <div className="text-center mb-16">
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-aurora-purple/20 mb-6"
                >
                  <span className="text-xs font-medium text-aurora-purple uppercase tracking-wider">
                    Simple Setup
                  </span>
                </motion.div>
                ...
                >
                  Get started in seconds. Our AI-powered system translates your hand
                  movements into seamless presentation controls.
                </motion.p>
              </div>
                ...
                {features.map((item, i) => (
                  ...
                  >
                    ...
                    <div className="relative glass rounded-3xl p-8 border border-dark-700/50 group-hover:border-aurora-cyan/20 transition-all duration-500 h-full">
                      {/* Step number */}
                      <span className="absolute top-6 right-8 font-mono text-6xl font-bold text-dark-700 group-hover:text-dark-600 transition-colors">
                        {item.step}
                      </span>

                      {/* Icon */}
                      <div className={`
                        relative w-16 h-16 rounded-2xl mb-6 flex items-center justify-center
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-display font-bold text-white">GesturePresenter</p>
                  <p className="text-xs text-slate-500">AI-Powered Control</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-3 text-xs text-slate-500">
                  ...
                  <div className="flex items-center gap-2">
                    {['React', 'MediaPipe', 'PDF.js'].map((tech, i) => (
                      <span
                        key={i}
                        className="px-2 py-1 rounded-md bg-dark-800 border border-dark-700 text-slate-400"
                      >
                        {tech}
                      </span>
                    ))}
            ...
            <div className="mt-8 pt-8 border-t border-dark-800 text-center">
              <p className="text-xs text-slate-600">
                Designed with passion by Opus 4.5
              </p>
            </div>
          </div>
        </footer>
